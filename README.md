...
The comments form automatically populates the email field with the student’s email value entered in the login form and allows the student to enter the course code, course name, and comments. The Thank You form thanks the user for providing the comments.
